...
const SkillCard = ({ icon: Icon, title, description}) => (
  <div className="flex flex-col items-center  p-6 rounded-lg shadow-2xl drop-shadow-black bg-zinc-950 dark:bg-zinc-800 hover:bg-black/50 dark:hover:bg-zinc-900 transition duration-300 ease-in-out">
    ...
    >
    <Icon size={38} className="text-4xl text-blue-500 dark:text-blue-400 mb-4" />
    </motion.span>
    <h3 className="text-xl font-medium text-white dark:text-white  mb-2">{title}</h3>
    <p className="text-gray-400 dark:text-gray-300 text-center text-sm">{description}</p>
  </div>
);
