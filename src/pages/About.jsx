    ...
    <>
      ...
      <Fade cascade duration={3000} damping={0.8}>
        <Section
          ...
          description={
            "Exiting project i currently deployed. check back soon my portfolio of full stack applications that demonstrate my techanical skills and problem-solving abilities"
          }
        >
          <AttentionSeeker effect="pulse" duration={1000}>
            <ProjectGrid />
